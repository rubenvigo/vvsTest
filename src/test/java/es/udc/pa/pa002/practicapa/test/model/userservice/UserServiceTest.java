...
public class UserServiceTest {
	...
	@Test
	public void testAddEventoAndFindEventoById()
		...
		Evento foundEvento = userService.findEventoById(addedEvento
				.getIdEvento());
	...
	public void testFindEventosByCategoryAdmin() {
		...
		foundEventos = userService.findEventos(null,
	...
	public void testFindEventosByKeywords() {
		...
		EventoBlock foundEventos;
		foundEventos = userService.findEventos("nombre evento", null, true, 0,
				10);
		assertEquals(eventos, foundEventos.getEventos());
		...
		foundEventos = userService.findEventos("Nombre del EVENTO", null, true,
				0, 10);
		assertEquals(eventos, foundEventos.getEventos());
		assertEquals(false, foundEventos.getExistMoreEventos());
		foundEventos.getEventos().clear();
	...
	public void testEstablecerGanadoras() throws EventoStartedException,
		...
		OpcionApuesta foundOpcionApuesta2 = opcionApuestaDao
				.find(opcionApuesta2.getIdOpcionApuesta());
	...
	public void testEstablecerGanadoras2() throws InstanceNotFoundException,
		...
		OpcionApuesta foundOpcionApuesta3 = opcionApuestaDao
				.find(opcionApuesta3.getIdOpcionApuesta());
		assertEquals(true, foundOpcionApuesta3.getEstado());
		OpcionApuesta foundOpcionApuesta4 = opcionApuestaDao
				.find(opcionApuesta4.getIdOpcionApuesta());
		assertEquals(false, foundOpcionApuesta4.getEstado());
		OpcionApuesta foundOpcionApuesta5 = opcionApuestaDao
				.find(opcionApuesta5.getIdOpcionApuesta());
	...
	@Test(expected = OpcionApuestaAlreadySolvedException.class)
	public void testEstablecerGanadorasFailed3()
	...
	public void testEstablecerGanadorasFailed4()
			throws InstanceNotFoundException, EventoStartedException,
			EventoNotStartedException, OpcionApuestaAlreadySolvedException,
			InputValidationException, SimpleWinnerException,
			InvalidDateException, InstanceAlreadyCreatedException,
	...
	public void testEstablecerGanadorasFailed5()
			throws InstanceNotFoundException, EventoStartedException,
			EventoNotStartedException, OpcionApuestaAlreadySolvedException,
			InputValidationException, SimpleWinnerException,
			InvalidDateException, InstanceAlreadyCreatedException,
	...
	public void testConsultarApuestas() throws EventoStartedException,
		...
		opcionesApuesta.add(opcionApuesta2);
		TipoApuesta tipoApuesta2 = userService.addTipoApuesta(addEvento
				.getIdEvento(), new TipoApuesta("Goleador", opcionesApuesta,
				false));
	...
	public void testFindCategoryById() throws InstanceNotFoundException {
		Categoria categoria1 = new Categoria("Futbol");
		categoriaDao.save(categoria1);
		Categoria foundCategoria = categoriaDao.find(categoria1
				.getIdCategoria());
	...
	@Test(expected = InstanceNotFoundException.class)
	public void testFindTipoApuestaInexistente()
			throws InstanceNotFoundException {
	...
	@Test(expected = InstanceNotFoundException.class)
	public void testFindOpcionApuestaInexistente()
			throws InstanceNotFoundException {
	...
	public void testGetNumberOfEventos() {
		...
		EventoBlock foundEventos;
		int numberEvents = userService.getNumberOfEventos("nombre evento",
				null, true);

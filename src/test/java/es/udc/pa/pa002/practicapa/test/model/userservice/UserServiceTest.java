...
public class UserServiceTest {
    ...
    @Test
    public void testAddEventoAndFindEventoById() throws InstanceNotFoundException, InvalidDateException, InstanceAlreadyCreatedException{
    ...
    public void testAddEventoPasado()throws InvalidDateException, InstanceAlreadyCreatedException{
    	Categoria categoria = new Categoria("Futbol");
    	categoriaDao.save(categoria);
    	Calendar fecha = Calendar.getInstance();
    ...
    public void testAddEventoDuplicado()throws InvalidDateException, InstanceAlreadyCreatedException{
    	Categoria categoria = new Categoria("Futbol");
    	categoriaDao.save(categoria);
    	Calendar fecha = Calendar.getInstance();
        fecha.set(2017, Calendar.AUGUST, 11, 10, 30);
    ...
    public void testFindEventosByCategoryAdmin(){
    	...
    	foundEventos = userService.findEventos(null, categoria2.getIdCategoria(),true, 0, 10);
    ...
    public void testFindEventosByCategoryUser(){
    	...
    	eventos.add(evento3);
    	EventoBlock foundEventos;
    	foundEventos = userService.findEventos(null, categoria2.getIdCategoria(),false, 0, 10);
    	assertEquals(eventos, foundEventos.getEventos());
    }
    ...
    public void testFindEventosByKeywords(){
    	...
    	foundEventos = userService.findEventos("Nombre del EVENTO", null,true, 0, 10);
    	assertEquals(eventos, foundEventos.getEventos());
    	assertEquals(false, foundEventos.getExistMoreEventos());
    	foundEventos.getEventos().clear();
    ...
    @Test
    public void testAddTipoApuesta() throws InstanceNotFoundException, EventoStartedException, InvalidDateException,
    InstanceAlreadyCreatedException, InstanceAlreadyCreatedException, RepeatedOpcionApuestaException{
    	Categoria categoria1 = new Categoria("Futbol");
    	categoriaDao.save(categoria1);
    	Calendar fecha = Calendar.getInstance();
        fecha.set(2017, Calendar.AUGUST, 11, 10, 30);
    	...
    	TipoApuesta addedTipoApuesta=userService.addTipoApuesta(addEvento.getIdEvento(),tipoApuesta);
    	TipoApuesta foundTipoApuesta=tipoApuestaDao.find(addedTipoApuesta.getIdTipoApuesta());
    	...
    	for(OpcionApuesta addedOpcionApuesta:tipoApuesta.getOpcionesApuesta()){
    		foundOpcionApuesta=opcionApuestaDao.find(addedOpcionApuesta.getIdOpcionApuesta());
    ...
    public void testAddTipoApuestaFailed() throws InstanceNotFoundException, InstanceAlreadyCreatedException, EventoStartedException, RepeatedOpcionApuestaException{
    	Categoria categoria1 = new Categoria("Futbol");
    	categoriaDao.save(categoria1);
    	Calendar fecha = Calendar.getInstance();
    ...
    @Test(expected=InstanceAlreadyCreatedException.class)
    public void testAddTipoApuestaFailed2() throws InstanceNotFoundException, InvalidDateException, InstanceAlreadyCreatedException,
    	InstanceAlreadyCreatedException, EventoStartedException, RepeatedOpcionApuestaException{
    	Categoria categoria1 = new Categoria("Futbol");
    	categoriaDao.save(categoria1);
    	Calendar fecha = Calendar.getInstance();
        fecha.set(2017, Calendar.AUGUST, 11, 10, 30);
    ...
    @Test(expected=InstanceNotFoundException.class)
    public void testAddTipoApuestaFailed3() throws InstanceNotFoundException, InputValidationException, InstanceAlreadyCreatedException, EventoStartedException, RepeatedOpcionApuestaException{
    ...
    public void testAddTipoApuestaFailed4() throws InstanceNotFoundException, InvalidDateException, InstanceAlreadyCreatedException,
    	InstanceAlreadyCreatedException, EventoStartedException, RepeatedOpcionApuestaException{
    	Categoria categoria1 = new Categoria("Futbol");
    	categoriaDao.save(categoria1);
    	Calendar fecha = Calendar.getInstance();
    ...
    @Test
    public void testApostar() throws InstanceNotFoundException, EventoStartedException, InvalidDateException, 
    	InstanceAlreadyCreatedException, InstanceAlreadyCreatedException, RepeatedOpcionApuestaException{
    	Categoria categoria1 = new Categoria("Futbol");
    	categoriaDao.save(categoria1);
    	Calendar fecha = Calendar.getInstance();
    	...
    	OpcionApuesta opcionApuesta=new OpcionApuesta("1",1.2F,null);
    	opcionesApuesta.add(opcionApuesta);
    	userService.addTipoApuesta(addEvento.getIdEvento(),new TipoApuesta("1X2",opcionesApuesta,false));
    	String clearPassword = "userPassword";
        UserProfile userProfile = registerUser("user", clearPassword);
        float cantidadApostada = 100;
        
      //Comprobamos que la  apuesta se inserta en la base de datos
    	ApuestaRealizada addapuestaRealizada = userService.apostar(opcionApuesta.getIdOpcionApuesta(), cantidadApostada, userProfile.getUserProfileId());
    	ApuestaRealizada foundApuestaRealizada = apuestaRealizadaDao.find(addapuestaRealizada.getIdApuestaRealizada());
    	assertEquals(addapuestaRealizada,foundApuestaRealizada);
    }
  
    @Test(expected=EventoStartedException.class)
    public void testApostarFailed() throws EventoStartedException, InvalidDateException, InstanceAlreadyCreatedException,
    	InstanceNotFoundException, InstanceAlreadyCreatedException, RepeatedOpcionApuestaException{
    	Categoria categoria1 = new Categoria("Futbol");
    	categoriaDao.save(categoria1);
    	Calendar fecha = Calendar.getInstance();
        fecha.set(2017, Calendar.AUGUST, 11, 10, 30);
        ...
        userService.apostar(opcionApuesta.getIdOpcionApuesta(), cantidadApostada, userProfile.getUserProfileId());	
    }
    
    @Test
    public void testEstablecerGanadoras() throws  EventoStartedException, EventoNotStartedException,
    OpcionApuestaAlreadySolvedException, InputValidationException, SimpleWinnerException, 
    InstanceAlreadyCreatedException, InstanceNotFoundException, InvalidDateException, 
    RepeatedOpcionApuestaException, InvalidOptionException{
    	...
    	String clearPassword = "userPassword";
        UserProfile userProfile = registerUser("user", clearPassword);
      	userService.apostar(opcionApuesta.getIdOpcionApuesta(), 100, userProfile.getUserProfileId());
    	userService.apostar(opcionApuesta2.getIdOpcionApuesta(), 100, userProfile.getUserProfileId());
    	...
    	userService.EspecificarGanadoras(opcionApuesta.getTipoApuesta().getIdTipoApuesta(), opcionesGanadoras);
    	
    	
    	OpcionApuesta foundOpcionApuesta=opcionApuestaDao.find(opcionApuesta.getIdOpcionApuesta());
    	assertEquals(true, foundOpcionApuesta.getEstado());
    	OpcionApuesta foundOpcionApuesta2=opcionApuestaDao.find(opcionApuesta2.getIdOpcionApuesta());
    ...
    EventoStartedException, EventoNotStartedException, OpcionApuestaAlreadySolvedException, 
    InputValidationException, SimpleWinnerException, InvalidDateException, InstanceAlreadyCreatedException,
    RepeatedOpcionApuestaException, InvalidOptionException{
    	Categoria categoria1 = new Categoria("Futbol");
    	categoriaDao.save(categoria1);
    	Calendar fecha = Calendar.getInstance();
    	...
    	userService.addTipoApuesta(addEvento.getIdEvento(),new TipoApuesta("tarjetas",opcionesApuesta,true));
    	
    	String clearPassword = "userPassword";
        UserProfile userProfile = registerUser("user", clearPassword);
      	userService.apostar(opcionApuesta3.getIdOpcionApuesta(), 100, userProfile.getUserProfileId());
    	userService.apostar(opcionApuesta4.getIdOpcionApuesta(), 100, userProfile.getUserProfileId());
    	...
    	userService.EspecificarGanadoras(opcionApuesta3.getTipoApuesta().getIdTipoApuesta(), opcionesGanadoras);
    	
    	
    	OpcionApuesta foundOpcionApuesta3=opcionApuestaDao.find(opcionApuesta3.getIdOpcionApuesta());
    	assertEquals(true, foundOpcionApuesta3.getEstado());
    	OpcionApuesta foundOpcionApuesta4=opcionApuestaDao.find(opcionApuesta4.getIdOpcionApuesta());
    	assertEquals(false, foundOpcionApuesta4.getEstado());
    	OpcionApuesta foundOpcionApuesta5=opcionApuestaDao.find(opcionApuesta5.getIdOpcionApuesta());
    ...
    InputValidationException, InvalidDateException, InstanceAlreadyCreatedException, 
    InstanceNotFoundException, SimpleWinnerException, RepeatedOpcionApuestaException, InvalidOptionException{
    	Categoria categoria1 = new Categoria("Futbol");
    	categoriaDao.save(categoria1);
    	Calendar fecha = Calendar.getInstance();
        fecha.set(2017, Calendar.AUGUST, 11, 10, 30);
  ...
  @Test(expected=OpcionApuestaAlreadySolvedException.class)
    ...
    EventoNotStartedException, OpcionApuestaAlreadySolvedException, InputValidationException, 
    SimpleWinnerException, InstanceAlreadyCreatedException, InstanceNotFoundException, 
    InvalidDateException, RepeatedOpcionApuestaException, InvalidOptionException{
    	Categoria categoria1 = new Categoria("Futbol");
    	categoriaDao.save(categoria1);
    	Calendar fecha = Calendar.getInstance();
        fecha.set(2017, Calendar.AUGUST, 11, 10, 30);
  ...
  EventoStartedException, EventoNotStartedException, OpcionApuestaAlreadySolvedException, 
  InputValidationException, SimpleWinnerException, InvalidDateException, 
  InstanceAlreadyCreatedException, RepeatedOpcionApuestaException, InvalidOptionException{
  	Categoria categoria1 = new Categoria("Futbol");
  	categoriaDao.save(categoria1);
  	Calendar fecha = Calendar.getInstance();
      fecha.set(2017, Calendar.AUGUST, 11, 10, 30);
  ...
  InstanceAlreadyCreatedException, RepeatedOpcionApuestaException, InvalidOptionException{
  	...
  	opcionesApuesta.add(opcionApuesta4);
  	opcionesApuesta.add(opcionApuesta5);
  	userService.addTipoApuesta(addEvento.getIdEvento(),new TipoApuesta("tarjetas",opcionesApuesta,false));
  ...
  InstanceAlreadyCreatedException, RepeatedOpcionApuestaException, InvalidOptionException{
    ...
    @Test
    public void testConsultarApuestas() throws EventoStartedException, InvalidDateException, InstanceAlreadyCreatedException,
    	InstanceNotFoundException, InstanceAlreadyCreatedException, RepeatedOpcionApuestaException{
    	Categoria categoria1 = new Categoria("Futbol");
    	categoriaDao.save(categoria1);
    	Calendar fecha = Calendar.getInstance();
    	...
    	TipoApuesta tipoApuesta1=userService.addTipoApuesta(addEvento.getIdEvento(),new TipoApuesta("1X2",opcionesApuesta,false));
    	
    	opcionesApuesta.remove(opcionApuesta1);
    	OpcionApuesta opcionApuesta2=new OpcionApuesta("Messi",1.2F,null);
    	opcionesApuesta.add(opcionApuesta2);
    	TipoApuesta tipoApuesta2=userService.addTipoApuesta(addEvento.getIdEvento(),new TipoApuesta("Goleador",opcionesApuesta,false));
        ...
        ApuestaRealizada apuesta1 = userService.apostar(opcionApuesta1.getIdOpcionApuesta(), 100, userProfile1.getUserProfileId());
        ApuestaRealizada apuesta2 = userService.apostar(opcionApuesta2.getIdOpcionApuesta(), 100, userProfile1.getUserProfileId());
        ApuestaRealizada apuesta3 = userService.apostar(opcionApuesta1.getIdOpcionApuesta(), 100, userProfile2.getUserProfileId());
        ...
        foundApuestas = userService.consultarApuestas(userProfile1.getUserProfileId(), 0, 2);
        ...
        foundApuestas = userService.consultarApuestas(userProfile1.getUserProfileId(), 0, 1);
    ...
    @Test
    public void testFindTipoApuestaById() throws InvalidDateException, InstanceAlreadyCreatedException, InstanceNotFoundException, 
    	EventoStartedException, InstanceAlreadyCreatedException, RepeatedOpcionApuestaException{
    	...
    	TipoApuesta foundTipo = userService.findTipoApuestaById(tipo.getIdTipoApuesta());
    ...
    @Test
    public void testFindOpcionApuestaById() throws InstanceNotFoundException, InvalidDateException, 
    	InstanceAlreadyCreatedException, EventoStartedException, InstanceAlreadyCreatedException, RepeatedOpcionApuestaException{
    	...
    	TipoApuesta tipo = new TipoApuesta("Goleador",opcionesApuesta,false);
    	userService.addTipoApuesta(addedEvento.getIdEvento(), tipo);
    	OpcionApuesta foundOpcion = userService.findOpcionApuestaById(opcionApuesta1.getIdOpcionApuesta());
    ...
    @Test
    public void testFindApuestaById() throws InstanceNotFoundException, InvalidDateException, 
    	InstanceAlreadyCreatedException, EventoStartedException, InstanceAlreadyCreatedException, RepeatedOpcionApuestaException{
        ...
        UserProfile userProfile1 = registerUser("user1", clearPassword1);
    	ApuestaRealizada apuesta1 = userService.apostar(opcionApuesta1.getIdOpcionApuesta(), 100, userProfile1.getUserProfileId());
    	ApuestaRealizada foundApuesta=userService.findApuestaById(apuesta1.getIdApuestaRealizada());
    ...
    public void testGetNumberOfEventos(){
    	...
    	EventoBlock foundEventos;    	
    	int numberEvents = userService.getNumberOfEventos("nombre evento", null,true);
    	assertEquals(2, numberEvents);
    	
    	numberEvents = userService.getNumberOfEventos(null, categoria1.getIdCategoria(),true);
     	assertEquals(2, numberEvents);

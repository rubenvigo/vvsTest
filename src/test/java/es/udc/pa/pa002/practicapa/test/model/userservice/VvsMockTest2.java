...
public class VvsMockTest2 {
	...
	public void findEventos() {
		...
		when(eventoDaoMock.findByParameters(null, null,true, 0, 3)).thenReturn(listaEventos);
	...
	public void findEventosNotEventos() {
		...
		when(eventoDaoMock.findByParameters("notexists", null,true, 0, 3)).thenReturn(listaEventos);
	...
	@Test
	public void addTipoApuesta() throws InstanceNotFoundException, EventoStartedException, InstanceAlreadyCreatedException, RepeatedOpcionApuestaException{
		Categoria categoria = new Categoria("Futbol");
		Calendar fecha = Calendar.getInstance();
		fecha.set(2017, Calendar.AUGUST, 11, 10, 30);
		Evento evento = new Evento("nombre", fecha, categoria);
	...
	@Test
	public void addTipoApuestaEventoNotFound() throws InstanceNotFoundException, EventoStartedException, InstanceAlreadyCreatedException, RepeatedOpcionApuestaException{
		thrown.expect(InstanceNotFoundException.class);
		Categoria categoria = new Categoria("Futbol");
		Calendar fecha = Calendar.getInstance();
		fecha.set(2017, Calendar.AUGUST, 11, 10, 30);
		...
		Set<OpcionApuesta> opcionesApuesta=new HashSet<OpcionApuesta>();
		TipoApuesta tipoApuesta = new TipoApuesta(evento,"pregunta",opcionesApuesta,false);
		when(eventoDaoMock.find(1L)).thenThrow(new InstanceNotFoundException("error",null));
	...
	@Test
	public void addTipoApuestaRepeatedTipoApuesta() throws InstanceNotFoundException, EventoStartedException, InstanceAlreadyCreatedException, RepeatedOpcionApuestaException{
		thrown.expect(InstanceAlreadyCreatedException.class);
		Categoria categoria = new Categoria("Futbol");
		Calendar fecha = Calendar.getInstance();
		fecha.set(2017, Calendar.AUGUST, 11, 10, 30);
	...
	@Test
	public void addTipoApuestaRepeatedOpcionApuesta() throws InstanceNotFoundException, EventoStartedException, InstanceAlreadyCreatedException, RepeatedOpcionApuestaException{
	...
	@Test
	public void apostarStartedEvent() throws InstanceNotFoundException, EventoStartedException{
	...
	@Test
	public void apostarOpcionNotFound() throws InstanceNotFoundException, EventoStartedException{
		thrown.expect(InstanceNotFoundException.class);
		...
		when(opcionApuestaDaoMock.find(1L)).thenThrow(new InstanceNotFoundException("error",null));
		userService.apostar(1L, 5, 1L);

	}
	
	@Test
	public void apostarUserNotFound() throws InstanceNotFoundException, EventoStartedException{
		thrown.expect(InstanceNotFoundException.class);
		...
		when(opcionApuestaDaoMock.find(1L)).thenReturn(opcionApuesta);
		when(userProfileDaoMock.find(1L)).thenThrow(new InstanceNotFoundException("error",null));
		userService.apostar(1L, 5, 1L);
	...
	@Test
	public void especificarGanadoras() throws InstanceNotFoundException, EventoNotStartedException, OpcionApuestaAlreadySolvedException, SimpleWinnerException, InvalidOptionException{
		Categoria categoria = new Categoria("Futbol");
		Calendar fecha = Calendar.getInstance();
	...
	@Test
	public void especificarGanadorasEventoNotStarted() throws InstanceNotFoundException, EventoNotStartedException, OpcionApuestaAlreadySolvedException, SimpleWinnerException, InvalidOptionException{
	...
	@Test
	public void especificarGanadorasAlreadySolved() throws InstanceNotFoundException, EventoNotStartedException, OpcionApuestaAlreadySolvedException, SimpleWinnerException, InvalidOptionException{
	...
	@Test
	public void especificarGanadorasSimpleWinnerException() throws InstanceNotFoundException, EventoNotStartedException, OpcionApuestaAlreadySolvedException, SimpleWinnerException, InvalidOptionException{
	...
	@Test
	public void especificarGanadorasInvalidOptionException() throws InstanceNotFoundException, EventoNotStartedException, OpcionApuestaAlreadySolvedException, SimpleWinnerException, InvalidOptionException{
	...
	@Test
	public void consultarapuesta() throws InstanceNotFoundException, EventoStartedException{
		Categoria categoria = new Categoria("Futbol");
		Calendar fecha = Calendar.getInstance();
		fecha.set(2017, Calendar.AUGUST, 11, 10, 30);
		Evento evento = new Evento("nombre", fecha, categoria);
	...
	@Test
	public void consultarapuesta2() throws InstanceNotFoundException, EventoStartedException{
		Categoria categoria = new Categoria("Futbol");
		Calendar fecha = Calendar.getInstance();
		fecha.set(2017, Calendar.AUGUST, 11, 10, 30);
		Evento evento = new Evento("nombre", fecha, categoria);
	...
	@Test
	public void consultarapuesta3() throws InstanceNotFoundException, EventoStartedException{
		Categoria categoria = new Categoria("Futbol");
		Calendar fecha = Calendar.getInstance();
		fecha.set(2017, Calendar.AUGUST, 11, 10, 30);
		Evento evento = new Evento("nombre", fecha, categoria);

...
private final static int APUESTAS_PER_PAGE = 10;
	...
	public boolean getIsWinner(){
		return (apuesta.getOpcionApuesta().getEstado()!=null && apuesta.getOpcionApuesta().getEstado()==true );
	}
	...
	void onActivate(int startIndex){
		...
		apuestaBlock = userService.consultarApuestas(userSession.getUserProfileId(), startIndex, APUESTAS_PER_PAGE);
	}

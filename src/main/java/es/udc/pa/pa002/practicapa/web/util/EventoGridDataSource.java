...
public class EventoGridDataSource implements GridDataSource {
	...
	public EventoGridDataSource(UserService userService,
			String keywords, Long idCategoria,boolean admin) {
    ...
    public int getAvailableRows() {
    	...
    	int numberEventos=userService.getNumberOfEventos(keywords, idCategoria, admin);
    	if(numberEventos==0) {
    		eventoNotFound=true;
    	}
    ...
    public void prepare(int startIndex, int endIndex,
    	...
    	eventos = userService.findEventos(keywords, idCategoria, admin, startIndex, endIndex-startIndex+1).getEventos();
